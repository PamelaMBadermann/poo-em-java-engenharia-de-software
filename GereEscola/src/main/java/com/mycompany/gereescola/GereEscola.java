...
//        grupo = new Pessoa [3];
//        grupo [0] = new Fisica ( "Marco Antônio" , data_nasc , null , "Brasil" , "Rio de Janeiro" );
//        grupo [1] = new Juridica ("Escola Novo Mundo Ltda" , data_nasc , null , "Brasil" , "Rio de Janeiro");
//        grupo [2] = new Pessoa ( null , null , null , "Brasil" , "Rio de Janeiro");
//        
//        for ( int i = 0 ; i <= 2 ; i++ )
