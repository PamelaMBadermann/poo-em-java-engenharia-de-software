...
public class Juridica extends Pessoa {
    ...
    public Juridica ( String razao_social , Calendar data_criacao, String CNPJ , String endereco , String nacionalidade , String sede , int idade) {
        super ( razao_social , data_criacao, CNPJ , endereco , nacionalidade , sede, idade);        
    }
